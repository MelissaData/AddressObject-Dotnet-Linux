...
# MelissaAddressObjectLinuxDotnet
#
# Downloads the required components and then builds and runs MelissaAddressObjectLinuxDotnet.
#
...
#   4. Build the project, then run it (single test address or interactive).
#
# Options:
...
#
# Examples:
#   ./MelissaAddressObjectLinuxDotnet.sh --license "your-license"
#   ./MelissaAddressObjectLinuxDotnet.sh --address "22382 Avenida Empresa" --city "Rancho Santa Margarita" --state "CA" --zip "92688" --license "your-license"
...
dotnet publish -f="net10.0" -c Release -o $BuildPath MelissaAddressObjectLinuxDotnet/MelissaAddressObjectLinuxDotnet.csproj
